...
public class FreteData {
	...
	public FreteData(double peso, String cepOrigem, String cepDestino, String nomeDestinatario,
			double vlTotalFrete, Date dataPrevistaEntrega, Date dataPrevistaConsulta) {
